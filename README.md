...
- Latest build status with azerothcore: [![Build Status](https://travis-ci.org/azerothcore/mod-npc-gambler.svg?branch=master)](https://travis-ci.org/azerothcore/mod-npc-gambler)
